...
public class AdapterViewVerticalBanner extends LinearLayout implements BaseBannerAdapter.OnDataChangedListener {
    ...
    public AdapterViewVerticalBanner(Context context) {
        this(context,null);
    }

    public AdapterViewVerticalBanner(Context context, AttributeSet attrs) {
        this(context, attrs,0);
    }

    public AdapterViewVerticalBanner(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.AdapterViewVerticalBanner);
        mGap = array.getInteger(R.styleable.AdapterViewVerticalBanner_gap,mGap);//轮播图的停顿时间
        mAnimDuration = array.getInteger(R.styleable.AdapterViewVerticalBanner_animDuration,mAnimDuration);//向上移动的动画时间
